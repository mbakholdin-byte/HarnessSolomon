"""Phase 4.0: Tests for EventType enum + ENABLED_BY_DEFAULT."""
...
class TestEventType:
    ...
    def test_all_14_events_exist(self) -> None:
        """14 events = 11 CC (Elicitation + Notification DEFERRED) + 3 custom."""
    ...
    def test_deferred_events_set_is_empty_phase4_0(self) -> None:
        """In Phase 4.0 all 15 events are implemented."""
        assert DEFERRED_EVENTS == frozenset()

    def test_enabled_by_default_contains_all_implemented_events(self) -> None:
        """All 14 events enabled by default."""
